                            ...
                            <div class="card-body">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="Bidang Usaha" value="<?= $resDetailBadanUsaha->bidangUsaha ?>" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="Kecamatan" value="<?= $resDetailBadanUsaha->kecamatan ?>" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        <label for="Nama" class="font-weight-bold">Nama</label>
                                        <input type="text" class="form-control" id="Nama" value="<?= $resDetailBadanUsaha->teamSurvey ?>" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
