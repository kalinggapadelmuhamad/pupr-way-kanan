            ...
            <div class="modal-body">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <a href="../assets/img/ktp/<?= $resDetailPekerja->ktp ?>" class="btn btn-md btn-primary d-block" target="_blank">KTP</a>
                    </div>
                    <div class="form-group col-md-2">
                        <label for="PendidikanTerakhir" class="font-weight-bold d-block">Pas Foto</label>
                        <a href="../assets/img/ktp/<?= $resDetailPekerja->foto ?>" class="btn btn-md btn-success d-block" target="_blank">Foto</a>
                    </div>
                    <div class="form-group col-md-2">
                        <label for="PendidikanTerakhir" class="font-weight-bold d-block">TTD</label>
                        <a href="../assets/img/ttd/<?= $resDetailPekerja->ttd ?>" class="btn btn-md btn-warning d-block" target="_blank">TTD</a>
                    </div>
                </div>
            </div>
